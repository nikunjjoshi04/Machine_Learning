...
model=naive_bayes_classifier.fit(predictors_train,target_train)
prediction=naive_bayes_classifier.predict(predictors_test)
print(naive_bayes_classifier.predict([0.9,0.9,0.9,0,1,0.7,0.9]))
