...
data=pd.read_csv("C:\\Users\\Nikunj\\Downloads\\Documents\\ml_practical\\Practicals\\k means\\book example\\column_2C_weka.csv")
print(data.head())
...
plt.scatter(C[:,0],C[:,1],C[:,2],marker='*',c='#050505')
